...
between Nokov motioncapture software and multiple client programs.
*/
...
typedef enum maReturnCode
{
    ...
    RC_TimeOut,            //!< No response from Nokov motioncapture software
...
/** This is how we see what type of data Nokov motioncapture software returned */
...
//! The description of the connection to Nokov motioncapture software.
/*!
This contains information about the host machine, the host program, and the connection status.
*/
typedef struct sHostInfo
{
    int           bFoundHost;              //!< True = have talked to Nokov motioncapture software
    int           LatestConfirmationTime;  //!< Time of last receipt from Nokov motioncapture software
    char          szHostMachineName[128];  //!< Name of machine Nokov motioncapture software is running on
...
//! The description of all the data that will stream from Nokov motioncapture software.
/*!
...
typedef struct sBodyDefs
{
	...
	//Older versions of Nokov motioncapture software did not provide these values. They will be 0/NULL if not provided by Nokov motioncapture software.
...
typedef struct sBodyData
{
	...
	//Old versions of Nokov motioncapture software didn't provide these.
...
typedef struct sRecordingStatus
{
    ...
    int            iFirstFrame;  //!< The frame number of the first data frame to be recorded from Nokov motioncapture software Live Mode
    int            iLastFrame;   //!< The frame number of the last data frame to be recorded from Nokov motioncapture software Live Mode
...
//! ALL the data for one frame streamed from Nokov motioncapture software.
/*!
...
{
    int            iFrame;                  //!< Nokov motioncapture software's frame number
...
//==================================================================
/*!
This is how the return value of a Sky Command to Nokov motioncapture software is retrieved. 
*/
typedef struct sSkyReturn
{
	maReturnCode	ReturnCode;			//This is Nokov motioncapture software's response to the command. RC_Okay implies it was executed.
 ...
 *    when the connection to Nokov motioncapture software is made.  This function is
...
/** This function gets information about the connection to Nokov motioncapture software
 *
 *  This function returns IP-Address information and Nokov motioncapture software version information.
...
/**   This function sends commands to Nokov motioncapture software and returns a response.
 *
 *    This function is an extendable interface between the Client programs
 *    and the Host (Nokov motioncapture software) program.  The commands are sent as readable text strings.
 *    The response is returned unaltered.
 *
 * \param szCommand - The request to send the Nokov motioncapture software
...
/**   This function sends a Sky command to Nokov motioncapture software and returns a response.
 *
 * \param szCommand - The Sky command, including arguments for Nokov motioncapture software to execute.
 * \param msTimeout - The amount if time in milliseconds to wait for a response from Nokov motioncapture software
 *
 \verbatim
Example:
...
/**   This function queries Nokov motioncapture software for its set of tracking objects.
 *
...
/** This function polls Nokov motioncapture software for the current frame
 *
 ...
 *
 *  Note: Nokov motioncapture software considers the current frame to be the latest LiveMode frame completed or,
 ...
 *  the data that has arrived from Nokov motioncapture software.  To properly use the sFrameOfData
...
/** This function pushes a skeleton definition to Nokov motioncapture software.
 *
 *  A skeleton, defined in an animation package can be used to start
 *  a skeleton model definition in Nokov motioncapture software.  The hierarchy and starting
 *  pose can come from the animation package.  The rest of the details
 *  of the skeleton get filled out in the Nokov motioncapture software interface.  The parameters
 ...
 * \return - RC_Okay, RC_NetworkError
*/
DLL int Cortex_SendHtr(sHierarchy *pHierarchy, tSegmentData *pFrame);    // Push a skeleton definition to Nokov motioncapture software
